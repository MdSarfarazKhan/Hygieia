...
public class BambooClientTests {
    ...
    public void init() {
        ...
        bambooClient = new BambooClientImpl(restOperationsSupplier, new BambooSettings());
    }
    ...
    public void instanceJobs_emptyResponse_returnsEmptyMap() {
        ...
        Map<BambooJob, Set<Build>> jobs = bambooClient.getInstanceJobs(URL);
    ...
    public void buildDetails_full() throws Exception {
        ...
        Build build = bambooClient.getBuildDetails(URL);
    ...
    private String getJson(String fileName) throws IOException {
        InputStream inputStream = BambooClientTests.class.getResourceAsStream(fileName);
